export const activateLayersWMS = (allCheckboxLists, activeLayers, viewer) => {
    ...
    allCheckboxLists.forEach(checkboxList => {
        ...
        checkboxList.addEventListener('checkboxListChanged', (event) => {
            ...
            toRemove.forEach(item => {
                viewer.removeLayerWMS(item._imageryProvider._layers);
            });
            ...
            for (const layer of activeLayers) {
                ...
                viewer.addLayerWMS(url, layer.layer, parameters);
            }
