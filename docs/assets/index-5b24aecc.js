var J=Object.defineProperty;var G=(r,s,e)=>s in r?J(r,s,{enumerable:!0,configurable:!0,writable:!0,value:e}):r[s]=e;var c=(r,s,e)=>(G(r,typeof s!="symbol"?s+"":s,e),e);(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))t(i);new MutationObserver(i=>{for(const n of i)if(n.type==="childList")for(const o of n.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&t(o)}).observe(document,{childList:!0,subtree:!0});function e(i){const n={};return i.integrity&&(n.integrity=i.integrity),i.referrerPolicy&&(n.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?n.credentials="include":i.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function t(i){if(i.ep)return;i.ep=!0;const n=e(i);fetch(i.href,n)}})();const j=[self.location.hostname,"fonts.gstatic.com","fonts.googleapis.com","cdn.jsdelivr.net"],F=r=>{var s=Date.now(),e=new URL(r.url);return e.protocol=self.location.protocol,e.hostname===self.location.hostname&&(e.search+=(e.search?"&":"?")+"cache-bust="+s),e.href};self.addEventListener("activate",r=>{r.waitUntil(self.clients.claim())});self.addEventListener("fetch",r=>{if(j.indexOf(new URL(r.request.url).hostname)>-1){const s=caches.match(r.request),e=F(r.request),t=fetch(e,{cache:"no-store"}),i=t.then(n=>n.clone());r.respondWith(Promise.race([t.catch(n=>s),s]).then(n=>n||t).catch(n=>{})),r.waitUntil(Promise.all([i,caches.open("pwa-cache")]).then(([n,o])=>n.ok&&o.put(r.request,n)).catch(n=>{}))}});class U extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"closed"}),this.routes={}}connectedCallback(){window.addEventListener("hashchange",()=>{this.checkRoute()})}addRoutes(s){this.routes=s,this.checkRoute()}changeRoute(s){if(s)this.shadow.innerHTML=this.routes[s]?this.routes[s].routingFunction():this.sendToNotFound();else{const e=Object.entries(this.routes).find(([t,i])=>i.type==="default");e?window.location.hash="#/"+e[0]:this.sendToNotFound()}}sendToNotFound(){Object.entries(this.routes).find(([e,t])=>t.type==="notFound")&&(window.location.hash="#/"+defaultRoute[0],this.changeRoute(defaultRoute[0]))}checkRoute(){const s=window.location.hash.slice(2);this.changeRoute(s)}}customElements.define("app-router",U);class h{constructor(){if(h._instance)return h._instance;this.listeners=[],h._instance=this}static get instance(){return h._instance||(h._instance=new h),h._instance}subscribe(s,e){this.listeners[s]||(this.listeners[s]=[]),this.listeners[s].push(e)}publish(s,e){this.listeners[s]&&this.listeners[s].forEach(t=>t(e))}}class w{constructor(s,e,t,i=[]){this.properties=s,this.layer=e,this.startingCoordinates=t,this.coordinatesArray=i,this.coordinatesArray.length===0&&this.coordinatesArray.push(t)}get id(){return this.layer.layer+this.startingCoordinates.latitude+this.startingCoordinates.longitude}static fromPoint(s,e,t){return new w(s,e,t)}static fromPolyline(s,e,t){return new w(s,e,t[0],t)}static fromPolygon(s,e,t,i){return new w(s,e,t,i)}}class p{constructor(){c(this,"_instance");if(p._instance)return p._instance;p._instance=this}static get instance(){return p._instance||(p._instance=new p),p._instance}getFeature(s,e){const t=this.getLayerName(s.id),i=this.getLayerByName(e,t),n=this.getRelevantProperties(s.id.properties,i.relevant_properties);let o,l;if(s.id.point){let a=s.id.position._value;l=this.checkCoordinates(a),o=w.fromPoint(n,i,l)}if(s.id.polyline){let a=s.id.polyline.positions._value;l=this.checkCoordinates(a),o=w.fromPolyline(n,i,l)}if(s.id.polygon){let a=s.id.polygon.hierarchy._value.positions;l=this.checkCoordinates(a);let u=this.getPolygonCenter(s.id.polygon);o=w.fromPolygon(n,i,u,l)}return o}getLayerName(s){let e;return e=s.properties.layerName._value,e}getLayerByName(s,e){for(const t in s){const i=s[t];if(Array.isArray(i)||typeof i=="object"){const n=this.getLayerByName(i,e);if(n)return n}else if(typeof i=="string"&&i.includes(e))return s}return null}getRelevantProperties(s,e){const t={};if(e){for(const i of e)if(s[i.property_name]){let n={property_name:i.property_name,display_name:i.display_name,type:i.type};s[i.property_name]._value&&(typeof s[i.property_name]._value=="string"?n.value=s[i.property_name]._value:n.value=s[i.property_name]._value.value),t[i.property_name]=n}return t.raiseName=s.raiseName._value,t.layerName=s.layerName._value,t}}checkCoordinates(s){if(Array.isArray(s)){let e=[];return s.map(t=>{let i=this.cartesianToCartographic(t);e.push(i)}),e}else return this.cartesianToCartographic(s)}cartesianToCartographic(s){const e=Cesium.Cartographic.fromCartesian(s);let t=Cesium.Math.toDegrees(e.longitude),i=Cesium.Math.toDegrees(e.latitude);return t=parseFloat(t.toFixed(8)),i=parseFloat(i.toFixed(8)),{longitude:t,latitude:i}}getPolygonCenter(s){const e=s.hierarchy.getValue().positions;if(e&&e.length==0)return;let t=0,i=0;for(let l=0;l<e.length;l++){let a=Cesium.Cartographic.fromCartesian(e[l]);t+=Cesium.Math.toDegrees(a.longitude),i+=Cesium.Math.toDegrees(a.latitude)}let n=t/e.length;return{latitude:i/e.length,longitude:n}}createGeoJson(s){return{type:"FeatureCollection",features:s.map(i=>({type:"Feature",geometry:{type:"Point",coordinates:[i.startingCoordinates.longitude,i.startingCoordinates.latitude]},properties:i.properties}))}}}class E{constructor(s,e,t,i){this.name=s,this.features=e.map(n=>new w(n.properties,n.layer,n.startingCoordinates,n.coordinatesArray)),this.type=t,this.lastSelected=i}}class d{constructor(){c(this,"_data");if(d._instance)return d._instance;d._instance=this}static get instance(){return d._instance||(d._instance=new d),d._instance}getData(){this.data={};let s=JSON.parse(localStorage.getItem("selectedTags"));s?this.data.selectedTags=s:this.data.selectedTags=[];let e=JSON.parse(localStorage.getItem("routes"));if(e)this.data.routes=e.map(n=>new E(n.name,n.features,n.type,n.lastSelected));else{e=[];let n=new E("Default",[],"default",!0);e.push(n),localStorage.setItem("routes",JSON.stringify(e)),this.data.routes=e}let t=JSON.parse(localStorage.getItem("theme"));t||(t=1),this.data.theme=t;let i=JSON.parse(localStorage.getItem("layers"));if(!i){i={};let n=[],o=[];i.active=n,i.bench=o}return this.data.layers=i,this.data}updateActiveLayers(s){let e=d.instance.getData().layers;e.active=[...s],localStorage.setItem("layers",JSON.stringify(e))}updateBenchLayers(s){let e=d.instance.getData().layers;e.bench=[...s],localStorage.setItem("layers",JSON.stringify(e))}resetLayers(){let s=d.instance.getData().layers;s.bench.length=0,s.active.length=0,localStorage.setItem("layers",JSON.stringify(s))}}class m{constructor(){c(this,"CATEGORIES_URL","./json/categories.json");c(this,"_data");if(m._instance)return m._instance;m._instance=this}static get instance(){return m._instance||(m._instance=new m),m._instance}get data(){return this._data}set data(s){this._data=s}getData(){return this.data?Promise.resolve(this.data):this.fetchAppData(this.CATEGORIES_URL).then(s=>(this.data=s,console.log(s),s))}async fetchAppData(s){try{const e=await fetch(s).then(i=>i.json()),t=await Promise.all(e.categories.map(async i=>{const n=await Promise.all(i.groups.map(async o=>{try{const l=await fetch(o);if(l.ok)return l.json();throw new Error(`Errore durante il recupero dei dati da ${o}`)}catch(l){return console.error(l),null}}));return i.groups=n,i}));return{...e,categories:t}}catch(e){throw console.error("Errore durante il recupero dei dati JSON",e),e}}}class f{constructor(){c(this,"THEMES_URL","./json/themes.json");c(this,"_themes");if(f._instance)return f._instance;f._instance=this}static get instance(){return f._instance||(f._instance=new f),f._instance}get themes(){return this._themes}set themes(s){this._themes=s}getThemes(){return this.themes?Promise.resolve(this.themes):fetch(this.THEMES_URL).then(s=>s.json()).then(s=>(this.themes=s,s))}}class b{constructor(){if(b._instance)return b._instance;b._instance=this}static get instance(){return b._instance||(b._instance=new b),b._instance}getPosition(){return new Promise((s,e)=>{navigator.geolocation.getCurrentPosition(t=>{s(t)},t=>{e(t)})})}}class W extends HTMLElement{constructor(){super();c(this,"_data");c(this,"_position");c(this,"filterLayersByTags",(e,t)=>{let i=[];return e.categories.map(n=>{n.groups.map(o=>{o.layers.map(l=>{l.tags&&t.some(a=>l.tags.includes(a))&&i.push({...l,tags:[...l.tags]})})})}),i});this.shadow=this.attachShadow({mode:"closed"})}get data(){return this._data}set data(e){this._data=e}get position(){return this._position}set position(e){this._position=e}async connectedCallback(){let e=document.createElement("app-splash");this.shadow.append(e),this.data=await m.instance.getData(),this.position={};try{let a=await b.instance.getPosition();this.position.latitude=a.coords.latitude,this.position.longitude=a.coords.longitude}catch(a){console.error("Impossibile recuperare la posizione",a)}this.shadow.innerHTML+=`
            ...
            `,this.shadow.append(this.button),this.button.addEventListener("click",()=>{this.dispatchEvent(new CustomEvent("read-info"))});const s=document.createElement("link");s.setAttribute("rel","stylesheet"),s.setAttribute("href","./css/play-info-btn.css"),this.shadow.append(s)}}customElements.define("app-play-info-btn",te);class se extends HTMLElement{constructor(){super();c(this,"_coordinates");this.shadow=this.attachShadow({mode:"closed"})}get coordinates(){return this._coordinates}set coordinates(e){this._coordinates=e}connectedCallback(){this.button=document.createElement("button"),this.button.innerHTML=`
