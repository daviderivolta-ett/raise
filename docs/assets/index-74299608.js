var j=Object.defineProperty;var G=(r,s,e)=>s in r?j(r,s,{enumerable:!0,configurable:!0,writable:!0,value:e}):r[s]=e;var c=(r,s,e)=>(G(r,typeof s!="symbol"?s+"":s,e),e);(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))t(i);new MutationObserver(i=>{for(const n of i)if(n.type==="childList")for(const o of n.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&t(o)}).observe(document,{childList:!0,subtree:!0});function e(i){const n={};return i.integrity&&(n.integrity=i.integrity),i.referrerPolicy&&(n.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?n.credentials="include":i.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function t(i){if(i.ep)return;i.ep=!0;const n=e(i);fetch(i.href,n)}})();const F=[self.location.hostname,"fonts.gstatic.com","fonts.googleapis.com","cdn.jsdelivr.net"],U=r=>{var s=Date.now(),e=new URL(r.url);return e.protocol=self.location.protocol,e.hostname===self.location.hostname&&(e.search+=(e.search?"&":"?")+"cache-bust="+s),e.href};self.addEventListener("activate",r=>{r.waitUntil(self.clients.claim())});self.addEventListener("fetch",r=>{if(F.indexOf(new URL(r.request.url).hostname)>-1){const s=caches.match(r.request),e=U(r.request),t=fetch(e,{cache:"no-store"}),i=t.then(n=>n.clone());r.respondWith(Promise.race([t.catch(n=>s),s]).then(n=>n||t).catch(n=>{})),r.waitUntil(Promise.all([i,caches.open("pwa-cache")]).then(([n,o])=>n.ok&&o.put(r.request,n)).catch(n=>{}))}});class W extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"closed"}),this.routes={}}connectedCallback(){window.addEventListener("hashchange",()=>{this.checkRoute()})}addRoutes(s){this.routes=s,this.checkRoute()}changeRoute(s){if(s)this.shadow.innerHTML=this.routes[s]?this.routes[s].routingFunction():this.sendToNotFound();else{const e=Object.entries(this.routes).find(([t,i])=>i.type==="default");e?window.location.hash="#/"+e[0]:this.sendToNotFound()}}sendToNotFound(){Object.entries(this.routes).find(([e,t])=>t.type==="notFound")&&(window.location.hash="#/"+defaultRoute[0],this.changeRoute(defaultRoute[0]))}checkRoute(){const s=window.location.hash.slice(2);this.changeRoute(s)}}customElements.define("app-router",W);class h{constructor(){if(h._instance)return h._instance;this.listeners=[],h._instance=this}static get instance(){return h._instance||(h._instance=new h),h._instance}subscribe(s,e){this.listeners[s]||(this.listeners[s]=[]),this.listeners[s].push(e)}publish(s,e){this.listeners[s]&&this.listeners[s].forEach(t=>t(e))}}class x{constructor(s,e,t,i=[]){this.properties=s,this.layer=e,this.startingCoordinates=t,this.coordinatesArray=i,this.coordinatesArray.length===0&&this.coordinatesArray.push(t)}get id(){return this.layer.layer+this.startingCoordinates.latitude+this.startingCoordinates.longitude}static fromPoint(s,e,t){return new x(s,e,t)}static fromPolyline(s,e,t){return new x(s,e,t[0],t)}static fromPolygon(s,e,t,i){return new x(s,e,t,i)}}class p{constructor(){c(this,"_instance");if(p._instance)return p._instance;p._instance=this}static get instance(){return p._instance||(p._instance=new p),p._instance}getFeature(s,e){const t=this.getLayerName(s.id),i=this.getLayerByName(e,t),n=this.getRelevantProperties(s.id.properties,i.relevant_properties);let o,l;if(s.id.point){let a=s.id.position._value;l=this.checkCoordinates(a),o=x.fromPoint(n,i,l)}if(s.id.polyline){let a=s.id.polyline.positions._value;l=this.checkCoordinates(a),o=x.fromPolyline(n,i,l)}if(s.id.polygon){let a=s.id.polygon.hierarchy._value.positions;l=this.checkCoordinates(a);let u=this.getPolygonCenter(s.id.polygon);o=x.fromPolygon(n,i,u,l)}return o}getLayerName(s){let e;return e=s.properties.layerName._value,e}getLayerByName(s,e){for(const t in s){const i=s[t];if(Array.isArray(i)||typeof i=="object"){const n=this.getLayerByName(i,e);if(n)return n}else if(typeof i=="string"&&i.includes(e))return s}return null}getRelevantProperties(s,e){const t={};if(e){for(const i of e)if(s[i.property_name]){let n={property_name:i.property_name,display_name:i.display_name,type:i.type};s[i.property_name]._value&&(typeof s[i.property_name]._value=="string"?n.value=s[i.property_name]._value:n.value=s[i.property_name]._value.value),t[i.property_name]=n}return t.raiseName=s.raiseName._value,t.layerName=s.layerName._value,t}}checkCoordinates(s){if(Array.isArray(s)){let e=[];return s.map(t=>{let i=this.cartesianToCartographic(t);e.push(i)}),e}else return this.cartesianToCartographic(s)}cartesianToCartographic(s){const e=Cesium.Cartographic.fromCartesian(s);let t=Cesium.Math.toDegrees(e.longitude),i=Cesium.Math.toDegrees(e.latitude);return t=parseFloat(t.toFixed(8)),i=parseFloat(i.toFixed(8)),{longitude:t,latitude:i}}getPolygonCenter(s){const e=s.hierarchy.getValue().positions;if(e&&e.length==0)return;let t=0,i=0;for(let l=0;l<e.length;l++){let a=Cesium.Cartographic.fromCartesian(e[l]);t+=Cesium.Math.toDegrees(a.longitude),i+=Cesium.Math.toDegrees(a.latitude)}let n=t/e.length;return{latitude:i/e.length,longitude:n}}createGeoJson(s){return{type:"FeatureCollection",features:s.map(i=>({type:"Feature",geometry:{type:"Point",coordinates:[i.startingCoordinates.longitude,i.startingCoordinates.latitude]},properties:i.properties}))}}}class A{constructor(s,e,t,i){this.name=s,this.features=e.map(n=>new x(n.properties,n.layer,n.startingCoordinates,n.coordinatesArray)),this.type=t,this.lastSelected=i}}class d{constructor(){c(this,"_data");if(d._instance)return d._instance;d._instance=this}static get instance(){return d._instance||(d._instance=new d),d._instance}getData(){this.data={};let s=JSON.parse(localStorage.getItem("selectedTags"));s?this.data.selectedTags=s:this.data.selectedTags=[];let e=JSON.parse(localStorage.getItem("routes"));if(e)this.data.routes=e.map(n=>new A(n.name,n.features,n.type,n.lastSelected));else{e=[];let n=new A("Default",[],"default",!0);e.push(n),localStorage.setItem("routes",JSON.stringify(e)),this.data.routes=e}let t=JSON.parse(localStorage.getItem("theme"));t||(t=1),this.data.theme=t;let i=JSON.parse(localStorage.getItem("layers"));if(!i){i={};let n=[],o=[];i.active=n,i.bench=o}return this.data.layers=i,this.data}updateActiveLayers(s){let e=d.instance.getData().layers;e.active=[...s],localStorage.setItem("layers",JSON.stringify(e))}updateBenchLayers(s){let e=d.instance.getData().layers;e.bench=[...s],localStorage.setItem("layers",JSON.stringify(e))}resetLayers(){let s=d.instance.getData().layers;s.bench.length=0,s.active.length=0,localStorage.setItem("layers",JSON.stringify(s))}}class m{constructor(){c(this,"CATEGORIES_URL","./json/categories.json");c(this,"_data");if(m._instance)return m._instance;m._instance=this}static get instance(){return m._instance||(m._instance=new m),m._instance}get data(){return this._data}set data(s){this._data=s}getData(){return this.data?Promise.resolve(this.data):this.fetchAppData(this.CATEGORIES_URL).then(s=>(this.data=s,console.log(s),s))}async fetchAppData(s){try{const e=await fetch(s).then(i=>i.json()),t=await Promise.all(e.categories.map(async i=>{const n=await Promise.all(i.groups.map(async o=>{try{const l=await fetch(o);if(l.ok)return l.json();throw new Error(`Errore durante il recupero dei dati da ${o}`)}catch(l){return console.error(l),null}}));return i.groups=n,i}));return{...e,categories:t}}catch(e){throw console.error("Errore durante il recupero dei dati JSON",e),e}}}class f{constructor(){c(this,"THEMES_URL","./json/themes.json");c(this,"_themes");if(f._instance)return f._instance;f._instance=this}static get instance(){return f._instance||(f._instance=new f),f._instance}get themes(){return this._themes}set themes(s){this._themes=s}getThemes(){return this.themes?Promise.resolve(this.themes):fetch(this.THEMES_URL).then(s=>s.json()).then(s=>(this.themes=s,s))}}class b{constructor(){if(b._instance)return b._instance;b._instance=this}static get instance(){return b._instance||(b._instance=new b),b._instance}getPosition(){return new Promise((s,e)=>{navigator.geolocation.getCurrentPosition(t=>{s(t)},t=>{e(t)})})}}class y{constructor(){c(this,"ROUTES_URL","./routes/routes.json");if(y._instance)return y._instance;y._instance=this}static get instance(){return y._instance||(y._instance=new y),y._instance}get data(){return this._data}set data(s){this._data=s}async getData(){return this.data?this.data:(this.data=await this.fetchData(this.ROUTES_URL),this.data)}async fetchData(s){try{const i=(await(await fetch(s)).json()).routes.map(async o=>(await fetch(o)).json());return await Promise.all(i)}catch(e){console.error("Errore durante il recupero dei dati:",e)}}getRelatedRoute(s){return this.data.filter(e=>e.features.some(t=>t.id==s.id))}}class Y extends HTMLElement{constructor(){super();c(this,"_data");c(this,"_position");c(this,"filterLayersByTags",(e,t)=>{let i=[];return e.categories.map(n=>{n.groups.map(o=>{o.layers.map(l=>{l.tags&&t.some(a=>l.tags.includes(a))&&i.push({...l,tags:[...l.tags]})})})}),i});this.shadow=this.attachShadow({mode:"closed"})}get data(){return this._data}set data(e){this._data=e}get position(){return this._position}set position(e){this._position=e}async connectedCallback(){let e=document.createElement("app-splash");this.shadow.append(e),this.data=await m.instance.getData(),this.suggestedRoutes=await y.instance.getData(),this.position={};try{let a=await b.instance.getPosition();this.position.latitude=a.coords.latitude,this.position.longitude=a.coords.longitude}catch(a){console.error("Impossibile recuperare la posizione",a)}this.shadow.innerHTML+=`
            ...
            `,this.list=this.shadow.querySelector(".list"),this.submit=this.shadow.querySelector(".submit"),this.skip=this.shadow.querySelector(".skip"),this.submit.disabled=!0,this.submit.addEventListener("click",()=>{localStorage.setItem("selectedTags",JSON.stringify(this.selected)),window.location.href="/raise/#/map"}),this.skip.addEventListener("click",()=>{localStorage.setItem("selectedTags",JSON.stringify([])),window.location.href="/raise/#/map"});const t=document.createElement("link");t.setAttribute("rel","stylesheet"),t.setAttribute("href","./css/tags.page.css"),this.shadow.append(t),this.render()}getTags(e){let t=[];e.categories.forEach(n=>{n.groups.forEach(o=>{o.layers.forEach(l=>{l.tags&&l.tags.forEach(a=>{t.push(a)})})})});const i=[...new Set(t)];return i.sort(),i}}customElements.define("page-tags",X);class C extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"closed"})}render(){this.getAttribute("is-open")=="false"?this.gliph.innerHTML="menu":this.gliph.innerHTML="close"}connectedCallback(){this.button=document.createElement("button"),this.button.innerHTML=`
            <span class="icon">
                <span class="material-symbols-outlined">menu</span>
            </span>
            `,this.shadow.append(this.button),this.gliph=this.shadow.querySelector(".material-symbols-outlined"),this.setAttribute("is-open","false");let s=this.getAttribute("is-open");this.btn=this.shadow.querySelector("button");const e=document.createElement("link");e.setAttribute("rel","stylesheet"),e.setAttribute("href","./css/tabs.toggle.component.css"),this.shadow.append(e),this.btn.addEventListener("click",()=>{s=this.getAttribute("is-open")==="true",this.setAttribute("is-open",!s+"")})}attributeChangedCallback(s,e,t){if(t!=e&&e!=null&&s=="is-open"){const i=new CustomEvent("drawer-toggle",{detail:{isOpen:t}});this.dispatchEvent(i),this.render()}}}c(C,"observedAttributes",["is-open"]);customElements.define("app-tabs-toggle",C);class K extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"closed"})}connectedCallback(){this.hasAttribute("icon")||this.setAttribute("icon","app"),this.hasAttribute("link")||this.setAttribute("link","/"),this.button=document.createElement("button"),this.button.innerHTML=`
            <a href="${this.getAttribute("link")}">
                <span class="icon">
                    <span class="material-symbols-outlined">${this.getAttribute("icon")}</span>
                </span>
            </a>
            `,this.shadow.append(this.button);const s=document.createElement("link");s.setAttribute("rel","stylesheet"),s.setAttribute("href","./css/icon.css"),this.shadow.append(s)}}customElements.define("app-link",K);class V extends HTMLElement{constructor(){super();c(this,"_themeIndex");this.shadow=this.attachShadow({mode:"closed"}),this._themeIndex=1}get themeIndex(){return this._themeIndex}set themeIndex(e){this._themeIndex=e,this.dispatchEvent(new CustomEvent("themechange",{detail:{themeIndex:e}}))}connectedCallback(){this.button=document.createElement("button"),this.button.innerHTML=`
            <span class="icon">
                <span class="material-symbols-outlined">contrast</span>
            </span>
            `,this.shadow.append(this.button),this.button.addEventListener("click",()=>{let t=this._themeIndex;t++,t>2&&(t=0),this.themeIndex=t,localStorage.setItem("theme",JSON.stringify(this._themeIndex))});const e=document.createElement("link");e.setAttribute("rel","stylesheet"),e.setAttribute("href","./css/themeIcon.component.css"),this.shadow.append(e)}}customElements.define("app-theme-icon",V);class S extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"open"})}focusInput(){this.input.focus()}render(){this.input.setAttribute("value",this.getAttribute("value")),this.input.value=this.getAttribute("value")}connectedCallback(){this.shadow.innerHTML=`
            <input type="search" name="search" id="search" placeholder="Cerca per livelli..." value="">
            `,this.input=this.shadow.querySelector("input"),this.hasAttribute("value")||this.setAttribute("value",""),this.input.addEventListener("input",e=>{this.setAttribute("value",this.input.value)}),document.addEventListener("add-layer",()=>this.setAttribute("value",""));const s=document.createElement("link");s.setAttribute("rel","stylesheet"),s.setAttribute("href","./css/searchbar.css"),this.shadow.append(s)}attributeChangedCallback(s,e,t){if(t!=e&&e!=null&&s=="value"){t=t.toLowerCase();let i=this.filterLayersByNameAndTag(m.instance.data,t);this.dispatchEvent(new CustomEvent("search",{detail:{searchValue:t,layers:i}})),this.render()}}filterLayersByNameAndTag(s,e){let t=[];return s.categories.forEach(i=>{i.groups.forEach(n=>{n.layers.forEach(o=>{(o.name.toLowerCase().includes(e)||o.tags.some(l=>l.includes(e)))&&t.push(o)})})}),t}}c(S,"observedAttributes",["value"]);customElements.define("app-searchbar",S);const w=class w extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"closed"}),w.snackbars.push(this)}render(){this.p.innerText=this.getAttribute("text")}connectedCallback(){const s=w.snackbars.indexOf(this);if(this.shadow.innerHTML=`
            <div class="snackbar">
                <div class="content">
                    <p></p>
                </div>
            ...
            `,this.setAttribute("is-active","true"),this.hasAttribute("text")||this.setAttribute("text",""),this.hasAttribute("type")||this.setAttribute("type","closable"),this.snackbar=this.shadow.querySelector(".snackbar"),this.content=this.shadow.querySelector(".content"),this.p=this.shadow.querySelector("p"),this.p.innerText=this.getAttribute("text"),this.getAttribute("type")=="closable"&&(this.getAttribute("text")==""&&this.setAttribute("text","Chiudi"),this.button=document.createElement("button"),this.button.innerHTML=`
                ...
                `,this.content.append(this.button),this.button.addEventListener("click",()=>this.setAttribute("is-active","false"))),this.getAttribute("type")=="temporary"){let t;this.hasAttribute("timeout")?t=this.getAttribute("timeout"):t=3e3,this.getAttribute("text")==""&&this.setAttribute("text","Attendere..."),this.bar=document.createElement("div"),this.bar.classList.add("bar-color"),this.bar.style.setProperty("width","100%"),this.snackbar.append(this.bar);let i=100,n=setInterval(()=>{i==0&&(clearInterval(n),this.setAttribute("is-active","false")),i--,this.bar.style.width=i+"%"},t/100)}if(this.getAttribute("type")=="loader"){this.getAttribute("text")==""&&this.setAttribute("text","Caricamento...");let t=document.createElement("div");t.classList.add("loader-icon"),this.content.prepend(t)}const e=document.createElement("link");e.setAttribute("rel","stylesheet"),e.setAttribute("href","./css/snackbar.component.css"),this.shadow.append(e),this.style.setProperty("bottom",`${56+64*s}px`)}attributeChangedCallback(s,e,t){t!=e&&t!=null&&e!=null&&(s=="text"&&this.render(),s=="is-active"&&t=="false"&&this.remove())}disconnectedCallback(){const s=w.snackbars.indexOf(this);s!==-1&&(w.snackbars.splice(s,1),this.updatePosition())}updatePosition(){w.snackbars.forEach((s,e)=>{s.style.setProperty("bottom",`${56+64*e}px`)})}static createInfoSnackbar(s){let e=document.createElement("app-snackbar");e.setAttribute("type","closable"),e.setAttribute("text",s),document.body.append(e)}static createLoaderSnackbar(){let s=document.createElement("app-snackbar");s.setAttribute("type","loader"),s.setAttribute("id","loading-layer"),document.body.append(s)}static createErrorSnackbar(s){let e=document.createElement("app-snackbar");e.setAttribute("type","closable"),e.setAttribute("text",`Si è verificato un errore durante il caricamento del layer ${s}`),e.setAttribute("id","error-snackbar"),document.body.append(e)}};c(w,"snackbars",[]),c(w,"observedAttributes",["text","is-active"]);let g=w;customElements.define("app-snackbar",g);class M extends HTMLElement{constructor(){super();c(this,"_layers");this.shadow=this.attachShadow({mode:"closed"}),this.hasAttribute("is-open")||this.setAttribute("is-open",!1)}get layers(){return this._layers}set layers(e){this._layers=e,this.render()}render(){if(this.div.innerHTML="",this.layers.length==0){let e=document.createElement("p");e.innerText="Nessun livello trovato",this.div.append(e)}else this.layers.forEach(e=>{let t=document.createElement("app-search-result-chip");t.layer=e,this.div.append(t),t.addEventListener("add-layer",i=>{document.dispatchEvent(new CustomEvent("add-layer",{detail:{layers:[i.detail.layer]}})),this.setAttribute("is-open",!1),g.createLoaderSnackbar()}),this.div.scrollTop=0})}connectedCallback(){this.shadow.innerHTML="<div></div>",this.div=this.shadow.querySelector("div");const e=document.createElement("link");e.setAttribute("rel","stylesheet"),e.setAttribute("href","./css/search-result.css"),this.shadow.append(e)}attributeChangedCallback(e,t,i){i!=t&&e=="is-open"&&(i=="true"?this.classList.add("visible"):this.classList.remove("visible"))}}c(M,"observedAttributes",["is-open"]);customElements.define("app-search-result",M);class k{constructor(){c(this,"_hex");c(this,"_rgba");this.hex,this.rgba,this.opacity=1}get hex(){return this._hex}set hex(s){this._hex=s}get rgba(){return this._rgba}set rgba(s){this._rgba=s}convertHexToRgba(s,e=this.opacity){let t=s.replace("#","");t.length===3&&(t=`${t[0]}${t[0]}${t[1]}${t[1]}${t[2]}${t[2]}`);const i=parseInt(t.substring(0,2),16),n=parseInt(t.substring(2,4),16),o=parseInt(t.substring(4,6),16);return e>1&&e<=100&&(e=e/100),this.rgba=`rgba(${i},${n},${o},${e})`,this.rgba}changeOpacity(s,e){const i=s.substring(5,s.length-1).split(","),[n,o,l]=i.map(u=>parseInt(u));return`rgba(${n},${o},${l},${e})`}}class Z extends HTMLElement{constructor(){super();c(this,"_layer");this.shadow=this.attachShadow({mode:"closed"}),this.colorManager=new k}get layer(){return this._layer}set layer(e){this._layer=e}render(){}connectedCallback(){this.shadow.innerHTML=`
            <div class="chip">
                <div class="info">
...
`;class ce extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"closed"}),this.transitioner=null}connectedCallback(){Cesium.Ion.defaultAccessToken="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiI5MjY2YmYxNy1mNTM2LTRlOWYtYTUyZC01ZmY0NjBhNzllMWEiLCJpZCI6MTY5MDU3LCJpYXQiOjE2OTU4ODQ4NzB9.bN66rOR5h37xuKVsuUSYRSLOGJy-34IhH9S1hr4NOOE",this.viewer=new Cesium.Viewer(this.shadow,{baseLayerPicker:!1,geocoder:!1,timeline:!1,animation:!1,homeButton:!1,navigationInstructionsInitiallyVisible:!1,navigationHelpButton:!1,sceneModePicker:!1,fullscreenButton:!1,infoBox:!1,sceneMode:Cesium.SceneMode.SCENE2D,mapMode2D:Cesium.MapMode2D.ROTATE,mapProjection:new Cesium.WebMercatorProjection}),this.viewer.screenSpaceEventHandler.setInputAction(t=>{this.dispatchEvent(new CustomEvent("map-click",{detail:{movement:t}}))},Cesium.ScreenSpaceEventType.LEFT_CLICK),this.viewer.screenSpaceEventHandler.setInputAction(t=>{this.mouseOver(t)},Cesium.ScreenSpaceEventType.MOUSE_MOVE),h.instance.subscribe("customroute-load",t=>{this.loadCustomDataSource(t,"custom-route","#01fdc0")}),h.instance.subscribe("feature-selected",t=>{const i=p.instance.createGeoJson([t]);this.loadCustomDataSource(i,"selected-feature","#185FD9")}),h.instance.subscribe("customroutecard-click",t=>{const i=p.instance.createGeoJson([t]);this.loadCustomDataSource(i,"selected-feature","#185FD9")}),this.viewer.dataSources.dataSourceAdded.addEventListener(()=>{const t=document.querySelectorAll("#loading-layer");t.length!==0&&t.forEach(i=>i.remove())});const s=document.createElement("style");s.innerHTML=re,this.shadow.append(s);const e=document.createElement("link");e.setAttribute("rel","stylesheet"),e.setAttribute("href","./css/cesium.css"),this.shadow.append(e)}getEntity(s){const e=s.position;return this.viewer.scene.pick(e)}setCameraToPosition(s){let e=this.viewer.camera.positionCartographic;e.height>2e6?e.height=2e3:e.height;const t=Cesium.Cartesian3.fromDegrees(s.longitude,s.latitude,e.height);this.viewer.camera.flyTo({destination:t,orientation:{heading:Cesium.Math.toRadians(0),pitch:Cesium.Math.toRadians(-90),roll:0},duration:.5})}checkUserPin(s){const e=this.viewer.entities.getById("user-pin");e?this.updateUserPin(e,s):this.createUserPin(s)}createUserPin(s){this.viewer.entities.add({name:"user_pin",id:"user-pin",position:Cesium.Cartesian3.fromDegrees(s.longitude,s.latitude,0),point:{pixelSize:8,color:Cesium.Color.BLUE,outlineColor:Cesium.Color.WHITE,outlineWidth:1}})}updateUserPin(s,e){s.position=Cesium.Cartesian3.fromDegrees(e.longitude,e.latitude,0)}mouseOver(s){const e=s.endPosition,t=this.viewer.scene.pick(e);Cesium.defined(t)&&Cesium.defined(t.id)?document.body.style.cursor="pointer":document.body.style.cursor="default"}changeMapMode(){let s=this.viewer.scene.mode;s===Cesium.SceneMode.SCENE3D?this.viewer.scene.morphTo2D(0):s===Cesium.SceneMode.SCENE2D&&this.viewer.scene.morphTo3D(0)}changeTheme(s){for(let e=0;e<=2;e++)e===s?this.viewer.imageryLayers.get(e).show=!0:this.viewer.imageryLayers.get(e).show=!1}getImageryProvider(s,e,t){return new Cesium.WebMapTileServiceImageryProvider({url:s,layer:e,style:"default",format:"image/jpeg",maximumLevel:19,tileMatrixSetID:"default",credit:new Cesium.Credit(t)})}loadImageryProviders(s){s.forEach(e=>{const t=this.getImageryProvider(e.url,e.layer,e.credit);this.viewer.imageryLayers.addImageryProvider(t)})}async loadLayers(s){const e=s.map(t=>this.createlayer(t).then(i=>({layer:t,success:i.success,data:i.data})));await Promise.all(e).then(async t=>{this.viewer.dataSources._dataSources.map(n=>n.name).forEach(n=>{n!=="custom-route"&&this.viewer.dataSources.getByName(n).forEach(l=>this.viewer.dataSources.remove(l))}),await Promise.all(t.map(async n=>{if(n.success){const o=await n.data.layer;o.name=n.layer.layer,this.viewer.dataSources.add(o),this.styleEntities(o,n.layer.style)}else{const o=document.querySelectorAll("#loading-layer"),l=document.querySelectorAll("#error-snackbar");o.length!==0&&o.forEach(a=>a.remove()),l.length!==0&&l.forEach(a=>a.remove()),g.createErrorSnackbar(n.layer.name)}}))})}async createlayer(s){const e=`${s.layer_url_wfs}?service=WFS&typeName=${s.layer}&outputFormat=application/json&request=GetFeature&srsname=EPSG:4326`;try{const i=await(await fetch(e)).json(),n=await this.createAdditionalProperties(i,s);return{success:!0,data:{features:n.features,layer:Cesium.GeoJsonDataSource.load(n)}}}catch(t){return console.log("Problema nel recupero del layer"),{success:!1,error:t}}}createAdditionalProperties(s,e){return s.features=s.features.map((t,i)=>(t.properties.raiseName=e.name+" "+i,t.properties.layerName=e.layer,t)),s}async loadCustomDataSource(s,e,t){this.viewer.dataSources.getByName(e).forEach(o=>{this.viewer.dataSources.remove(o)});let n=await Cesium.GeoJsonDataSource.load(s);n.name=e,await this.viewer.dataSources.add(n),this.styleCustomDataSource(n,t)}styleCustomDataSource(s,e){s.entities.values.forEach(t=>{t.billboard=void 0,t.point=new Cesium.PointGraphics({pixelSize:16,color:Cesium.Color.fromCssColorString(e).withAlpha(.01),outlineColor:Cesium.Color.fromCssColorString(e),outlineWidth:3})})}styleEntities(s,e){let t="YELLOW",i="YELLOW",n=.5;e&&e.color&&(t=e.color.toUpperCase(),i=e.color.toUpperCase()),e&&e.opacity&&(n=e.opacity),s.entities.values.forEach(o=>{switch(!0){case Cesium.defined(o.polyline):o.polyline.material=Cesium.Color.fromCssColorString(t).withAlpha(parseFloat(n)),o.polyline.width=2;break;case Cesium.defined(o.billboard):o.billboard=void 0,o.point=new Cesium.PointGraphics({pixelSize:8,color:Cesium.Color.fromCssColorString(i).withAlpha(.5),outlineColor:Cesium.Color.fromCssColorString(i),outlineWidth:1});break;case Cesium.defined(o.polygon):o.polygon.material=Cesium.Color.fromCssColorString(t).withAlpha(parseFloat(n)),o.polygon.outlineColor=Cesium.Color.fromCssColorString(t).withAlpha(parseFloat(n));break}})}}customElements.define("app-cesium",ce);class q extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"closed"})}render(){switch(this.getAttribute("active-tab")){case"suggested-route":this.suggestedRouteContent.classList.add("active"),this.customRouteContent.classList.remove("active"),this.infoContent.classList.remove("active"),this.tabs.forEach(e=>{e.id==="suggested-route-tab"?e.classList.add("active-tab"):e.classList.remove("active-tab")});break;case"custom-route":this.suggestedRouteContent.classList.remove("active"),this.customRouteContent.classList.add("active"),this.infoContent.classList.remove("active"),this.tabs.forEach(e=>{e.id==="custom-route-tab"?e.classList.add("active-tab"):e.classList.remove("active-tab")});break;default:this.suggestedRouteContent.classList.remove("active"),this.customRouteContent.classList.remove("active"),this.infoContent.classList.add("active"),this.tabs.forEach(e=>{e.id==="info-tab"?e.classList.add("active-tab"):e.classList.remove("active-tab")});break}}connectedCallback(){this.shadow.innerHTML=`
            ...
            `,this.component=this.shadow.querySelector(".component"),this.header=this.shadow.querySelector(".header"),this.legend=this.shadow.querySelector(".legend"),this.name=this.shadow.querySelector(".name"),this.category=this.shadow.querySelector(".category"),this.tools=this.shadow.querySelector(".tools"),this.goToBtn=this.shadow.querySelector("app-goto"),this.addToRouteBtn=this.shadow.querySelector("app-add-to-route"),this.info=this.shadow.querySelector("app-info-panel"),this.header.addEventListener("click",()=>{h.instance.publish("tabinfocard-click",this.feature)}),this.goToBtn.addEventListener("go-to",t=>{this.goTo(t.detail.coordinates)}),this.addToRouteBtn.addEventListener("add-route",t=>{h.instance.publish("addtocustomroutebtn-click",this.feature)});const e=document.createElement("link");e.setAttribute("rel","stylesheet"),e.setAttribute("href","./css/tab.info.component.css"),this.shadow.append(e)}goTo(e){const t=`https://www.google.com/maps/dir/?api=1&destination=${e.latitude},${e.longitude}`;window.open(t,"_blank")}}customElements.define("app-tab-info",le);class de extends HTMLElement{constructor(){super();c(this,"_routes");c(this,"_route");this.shadow=this.attachShadow({mode:"closed"})}get routes(){return this._routes}set routes(e){this._routes=e}async connectedCallback(){this.shadow.innerHTML=`
            <div>
            </div>
            `}}customElements.define("app-tab-suggested-routes",de);class v{constructor(){c(this,"_instance");if(v._instance)return v._instance;v._instance=this}static get instance(){return v._instance||(v._instance=new v),v._instance}calculateDistance(s,e){const t=s.longitude-e.longitude,i=s.latitude-e.latitude;return Math.sqrt(t*t+i*i)}nearestInsertion(s,e){const t=[...s];let i=0,n=this.calculateDistance(e,t[0].startingCoordinates);for(let l=1;l<t.length;l++){const a=this.calculateDistance(e,t[l].startingCoordinates);a<n&&(n=a,i=l)}const o=[t.splice(i,1)[0]];for(;t.length>0;){n=Number.MAX_VALUE;let l;for(let a=0;a<t.length;a++){const u=this.calculateDistance(o[o.length-1].startingCoordinates,t[a].startingCoordinates);u<n&&(n=u,l=a)}o.push(t.splice(l,1)[0])}return o}}class he extends HTMLElement{constructor(){super();c(this,"_route");c(this,"_features");this.shadow=this.attachShadow({mode:"closed"}),this.features=[],this.shadow.innerHTML=`
            ...
            `,this.hasAttribute("is-name-available")||this.setAttribute("is-name-available",!0),this.dialog=this.shadow.querySelector("dialog"),this.input=this.shadow.querySelector("input"),this.validation=this.shadow.querySelector(".validation"),this.closeBtn=this.shadow.querySelector(".close"),this.saveBtn=this.shadow.querySelector(".submit"),this.deleteBtn=this.shadow.querySelector(".delete");const e=document.createElement("link");e.setAttribute("rel","stylesheet"),e.setAttribute("href","./css/dialog.edit-route.component.css"),this.shadow.append(e)}get route(){return this._route}set route(e){this._route=e,this.render()}get routes(){return this._routes}set routes(e){this._routes=e}render(){this.input.value=this.route.name,this.input.value.length===0?this.saveBtn.disabled=!0:this.saveBtn.disabled=!1}connectedCallback(){this.input.addEventListener("input",()=>{if(this.input.value.length===0)this.saveBtn.disabled=!0;else{this.setAttribute("is-name-available",!0),this.routes.forEach(t=>{if(t.name.toLowerCase()===this.input.value.toLowerCase()){this.setAttribute("is-name-available",!1);return}});let e=JSON.parse(this.getAttribute("is-name-available"));this.saveBtn.disabled=!e}}),this.closeBtn.addEventListener("click",()=>{this.closeDialog()}),this.saveBtn.addEventListener("click",()=>{this.closeDialog(),this.dispatchEvent(new CustomEvent("edit-name",{detail:{oldName:this.route.name,newName:this.input.value}}))}),this.deleteBtn.addEventListener("click",()=>{this.closeDialog(),this.dispatchEvent(new CustomEvent("delete-route",{detail:{name:this.route.name}}))})}attributeChangedCallback(e,t,i){i!=t&&e=="is-name-available"&&(i=="false"?this.validation.classList.add("not-available"):this.validation.classList.remove("not-available"))}openDialog(){this.dialog.showModal?this.dialog.showModal():this.dialog.setAttribute("open","")}closeDialog(){this.dialog.close?this.dialog.close():this.dialog.removeAttribute("open")}}c(R,"observedAttributes",["is-name-available"]);customElements.define("app-edit-route-dialog",R);class pe extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"closed"}),this.shadow.innerHTML=`
            <dialog>
                <div class="content">
                    <div class="message">
            ...
            `,this.dialog=this.shadow.querySelector("dialog"),this.closeBtn=this.shadow.querySelector(".cancel"),this.deleteBtn=this.shadow.querySelector(".delete");const s=document.createElement("link");s.setAttribute("rel","stylesheet"),s.setAttribute("href","./css/dialog.empty-route.component.css"),this.shadow.append(s)}connectedCallback(){this.closeBtn.addEventListener("click",()=>this.closeDialog()),this.deleteBtn.addEventListener("click",()=>{this.closeDialog(),this.dispatchEvent(new CustomEvent("empty-route"))})}openDialog(){this.dialog.showModal?this.dialog.showModal():this.dialog.setAttribute("open","")}closeDialog(){this.dialog.close?this.dialog.close():this.dialog.removeAttribute("open")}}customElements.define("app-empty-route",pe);class me extends HTMLElement{constructor(){super();c(this,"_route");this.shadow=this.attachShadow({mode:"closed"}),this.shadow.innerHTML=`
            <dialog>
                <div class="content">
                    <div class="message">
            ...
            `,this.dialog=this.shadow.querySelector("dialog"),this.routeName=this.shadow.querySelector(".route-name"),this.closeBtn=this.shadow.querySelector(".cancel"),this.saveBtn=this.shadow.querySelector(".save");const e=document.createElement("link");e.setAttribute("rel","stylesheet"),e.setAttribute("href","./css/dialog.save-route.component.css"),this.shadow.append(e)}get route(){return this._route}set route(e){this._route=e,this.render()}render(){this.routeName.innerHTML=this.route.name}connectedCallback(){this.closeBtn.addEventListener("click",()=>this.closeDialog()),this.saveBtn.addEventListener("click",()=>{this.closeDialog(),this.dispatchEvent(new CustomEvent("save-route"))})}openDialog(){this.dialog.showModal?this.dialog.showModal():this.dialog.setAttribute("open","")}closeDialog(){this.dialog.close?this.dialog.close():this.dialog.removeAttribute("open")}}customElements.define("app-save-route-dialog",me);class be extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"closed"}),this.shadow.innerHTML=`
            <dialog>
                <div class="content">
                    <div class="message">
            ...
            `,this.dialog=this.shadow.querySelector("dialog"),this.routeName=this.shadow.querySelector(".route-name"),this.closeBtn=this.shadow.querySelector(".cancel"),this.sortBtn=this.shadow.querySelector(".sort");const s=document.createElement("link");s.setAttribute("rel","stylesheet"),s.setAttribute("href","./css/dialog.sort-route.component.css"),this.shadow.append(s)}get route(){return this._route}set route(s){this._route=s,this.render()}render(){this.routeName.innerHTML=this.route.name}connectedCallback(){this.closeBtn.addEventListener("click",()=>this.closeDialog()),this.sortBtn.addEventListener("click",()=>{this.closeDialog(),this.dispatchEvent(new CustomEvent("sort-route"))})}openDialog(){this.dialog.showModal?this.dialog.showModal():this.dialog.setAttribute("open","")}closeDialog(){this.dialog.close?this.dialog.close():this.dialog.removeAttribute("open")}}customElements.define("app-sort-route-dialog",be);class N extends HTMLElement{constructor(){super();c(this,"_routes");this.shadow=this.attachShadow({mode:"closed"}),this.shadow.innerHTML=`
            <dialog>
                <div class="content">
                    <div class="message">
            ...
            `,this.dialog=this.shadow.querySelector("dialog"),this.closeBtn=this.shadow.querySelector(".close"),this.closeBtn.addEventListener("click",()=>this.closeDialog());const s=document.createElement("link");s.setAttribute("rel","stylesheet"),s.setAttribute("href","./css/dialog.no-position-error.component.css"),this.shadow.append(s)}openDialog(){this.dialog.showModal?this.dialog.showModal():this.dialog.setAttribute("open","")}closeDialog(){this.dialog.close?this.dialog.close():this.dialog.removeAttribute("open")}}customElements.define("app-no-position-dialog",fe);let ye=()=>"<page-map></page-map>",ve=()=>"<page-tags></page-tags>";const we=document.querySelector("app-router"),xe={index:{routingFunction:ve,type:"default"},map:{routingFunction:ye,type:"map"}};we.addRoutes(xe);
