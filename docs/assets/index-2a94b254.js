var R=Object.defineProperty;var N=(a,s,e)=>s in a?R(a,s,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[s]=e;var r=(a,s,e)=>(N(a,typeof s!="symbol"?s+"":s,e),e);(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))t(i);new MutationObserver(i=>{for(const n of i)if(n.type==="childList")for(const o of n.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&t(o)}).observe(document,{childList:!0,subtree:!0});function e(i){const n={};return i.integrity&&(n.integrity=i.integrity),i.referrerPolicy&&(n.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?n.credentials="include":i.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function t(i){if(i.ep)return;i.ep=!0;const n=e(i);fetch(i.href,n)}})();const G=[self.location.hostname,"fonts.gstatic.com","fonts.googleapis.com","cdn.jsdelivr.net"],F=a=>{var s=Date.now(),e=new URL(a.url);return e.protocol=self.location.protocol,e.hostname===self.location.hostname&&(e.search+=(e.search?"&":"?")+"cache-bust="+s),e.href};self.addEventListener("activate",a=>{a.waitUntil(self.clients.claim())});self.addEventListener("fetch",a=>{if(G.indexOf(new URL(a.request.url).hostname)>-1){const s=caches.match(a.request),e=F(a.request),t=fetch(e,{cache:"no-store"}),i=t.then(n=>n.clone());a.respondWith(Promise.race([t.catch(n=>s),s]).then(n=>n||t).catch(n=>{})),a.waitUntil(Promise.all([i,caches.open("pwa-cache")]).then(([n,o])=>n.ok&&o.put(a.request,n)).catch(n=>{}))}});class J extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"closed"}),this.routes={}}connectedCallback(){console.log("Connected!"),window.addEventListener("hashchange",()=>{this.checkRoute()})}addRoutes(s){this.routes=s,this.checkRoute()}changeRoute(s){if(console.log("Route changed:",s),s)this.shadow.innerHTML=this.routes[s]?this.routes[s].routingFunction():this.sendToNotFound();else{const e=Object.entries(this.routes).find(([t,i])=>i.type==="default");e?window.location.hash="#/"+e[0]:this.sendToNotFound()}}sendToNotFound(){Object.entries(this.routes).find(([e,t])=>t.type==="notFound")&&(window.location.hash="#/"+defaultRoute[0],this.changeRoute(defaultRoute[0]))}checkRoute(){const s=window.location.hash.slice(2);this.changeRoute(s)}}customElements.define("app-router",J);class l{constructor(){if(l._instance)return l._instance;this.listeners=[],l._instance=this}static get instance(){return l._instance||(l._instance=new l),l._instance}subscribe(s,e){this.listeners[s]||(this.listeners[s]=[]),this.listeners[s].push(e)}publish(s,e){this.listeners[s]&&this.listeners[s].forEach(t=>t(e))}}class y{constructor(s,e,t,i=[]){this.properties=s,this.layer=e,this.startingCoordinates=t,this.coordinatesArray=i,this.coordinatesArray.length===0&&this.coordinatesArray.push(t)}get id(){return this.layer.layer+this.startingCoordinates.latitude+this.startingCoordinates.longitude}static fromPoint(s,e,t){return new y(s,e,t)}static fromPolyline(s,e,t){return new y(s,e,t[0],t)}static fromPolygon(s,e,t,i){return new y(s,e,t,i)}}class u{constructor(){r(this,"_instance");if(u._instance)return u._instance;u._instance=this}static get instance(){return u._instance||(u._instance=new u),u._instance}getFeature(s,e){const t=this.getLayerName(s.id),i=this.getLayerByName(e,t),n=this.getRelevantProperties(s.id.properties,i.relevant_properties);let o,c;if(s.id.point){let d=s.id.position._value;c=this.checkCoordinates(d),o=y.fromPoint(n,i,c)}if(s.id.polyline){let d=s.id.polyline.positions._value;c=this.checkCoordinates(d),o=y.fromPolyline(n,i,c)}if(s.id.polygon){let d=s.id.polygon.hierarchy._value.positions;c=this.checkCoordinates(d);let b=this.getPolygonCenter(s.id.polygon);o=y.fromPolygon(n,i,b,c)}return o}getLayerName(s){let e;return e=s.properties.layerName._value,e}getLayerByName(s,e){for(const t in s){const i=s[t];if(Array.isArray(i)||typeof i=="object"){const n=this.getLayerByName(i,e);if(n)return n}else if(typeof i=="string"&&i.includes(e))return s}return null}getRelevantProperties(s,e){const t={};if(e){for(const i of e)if(s[i.property_name]){let n={property_name:i.property_name,display_name:i.display_name,type:i.type};typeof s[i.property_name]._value=="string"?n.value=s[i.property_name]._value:n.value=s[i.property_name]._value.value,t[i.property_name]=n}return t.raiseName=s.raiseName._value,t.layerName=s.layerName._value,t}}checkCoordinates(s){if(Array.isArray(s)){let e=[];return s.map(t=>{let i=this.cartesianToCartographic(t);e.push(i)}),e}else return this.cartesianToCartographic(s)}cartesianToCartographic(s){const e=Cesium.Cartographic.fromCartesian(s);let t=Cesium.Math.toDegrees(e.longitude),i=Cesium.Math.toDegrees(e.latitude);return t=parseFloat(t.toFixed(8)),i=parseFloat(i.toFixed(8)),{longitude:t,latitude:i}}getPolygonCenter(s){const e=s.hierarchy.getValue().positions;if(e&&e.length==0)return;let t=0,i=0;for(let c=0;c<e.length;c++){let d=Cesium.Cartographic.fromCartesian(e[c]);t+=Cesium.Math.toDegrees(d.longitude),i+=Cesium.Math.toDegrees(d.latitude)}let n=t/e.length;return{latitude:i/e.length,longitude:n}}createGeoJson(s){return{type:"FeatureCollection",features:s.map(i=>({type:"Feature",geometry:{type:"Point",coordinates:[i.startingCoordinates.longitude,i.startingCoordinates.latitude]},properties:i.properties}))}}}class x{constructor(s,e,t,i){this.name=s,this.features=e.map(n=>new y(n.properties,n.layer,n.startingCoordinates,n.coordinatesArray)),this.type=t,this.lastSelected=i}}class h{constructor(){r(this,"_data");if(h._instance)return h._instance;h._instance=this}static get instance(){return h._instance||(h._instance=new h),h._instance}getData(){this.data={};let s=JSON.parse(localStorage.getItem("selectedTags"));s?this.data.selectedTags=s:this.data.selectedTags=[];let e=JSON.parse(localStorage.getItem("routes"));if(e)this.data.routes=e.map(i=>new x(i.name,i.features,i.type,i.lastSelected));else{e=[];let i=new x("Default",[],"default",!0);e.push(i),localStorage.setItem("routes",JSON.stringify(e)),this.data.routes=e}let t=JSON.parse(localStorage.getItem("theme"));return t||(t=1),this.data.theme=t,console.log("Local storage:",this.data),this.data}}class p{constructor(){r(this,"CATEGORIES_URL","./json/categories.json");r(this,"_data");if(p._instance)return p._instance;p._instance=this}static get instance(){return p._instance||(p._instance=new p),p._instance}get data(){return this._data}set data(s){this._data=s}getData(){return this.data?Promise.resolve(this.data):this.fetchAppData(this.CATEGORIES_URL).then(s=>(this.data=s,s))}async fetchAppData(s){try{const e=await fetch(s).then(i=>i.json()),t=await Promise.all(e.categories.map(async i=>{const n=await Promise.all(i.groups.map(async o=>{try{const c=await fetch(o);if(c.ok)return c.json();throw new Error(`Errore durante il recupero dei dati da ${o}`)}catch(c){return console.error(c),null}}));return i.groups=n,i}));return{...e,categories:t}}catch(e){throw console.error("Errore durante il recupero dei dati JSON",e),e}}}class g{constructor(){r(this,"THEMES_URL","./json/themes.json");r(this,"_themes");if(g._instance)return g._instance;g._instance=this}static get instance(){return g._instance||(g._instance=new g),g._instance}get themes(){return this._themes}set themes(s){this._themes=s}getThemes(){return this.themes?Promise.resolve(this.themes):fetch(this.THEMES_URL).then(s=>s.json()).then(s=>(this.themes=s,s))}}class m{constructor(){if(m._instance)return m._instance;m._instance=this}static get instance(){return m._instance||(m._instance=new m),m._instance}getPosition(){return new Promise((s,e)=>{navigator.geolocation.getCurrentPosition(t=>{s(t)},t=>{e(t)})})}}class j extends HTMLElement{constructor(){super();r(this,"_data");r(this,"_position");r(this,"filterLayersByTags",(e,t)=>{let i=[];return e.categories.map(n=>{n.groups.map(o=>{o.layers.map(c=>{c.tags&&t.some(d=>c.tags.includes(d))&&i.push({...c,tags:[...c.tags]})})})}),i});this.shadow=this.attachShadow({mode:"closed"})}get data(){return this._data}set data(e){this._data=e}get position(){return this._position}set position(e){this._position=e}async connectedCallback(){let e=document.createElement("app-splash");this.shadow.append(e),this.data=await p.instance.getData(),this.position={};try{let n=await m.instance.getPosition();this.position.latitude=n.coords.latitude,this.position.longitude=n.coords.longitude}catch(n){console.error("Impossibile recuperare la posizione",n)}this.shadow.innerHTML+=`
            ...
            `,this.shadow.append(this.button),this.button.addEventListener("click",()=>{this.dispatchEvent(new CustomEvent("read-info"))});const s=document.createElement("link");s.setAttribute("rel","stylesheet"),s.setAttribute("href","./css/play-info-btn.css"),this.shadow.append(s)}}customElements.define("app-play-info-btn",Q);class ee extends HTMLElement{constructor(){super();r(this,"_coordinates");this.shadow=this.attachShadow({mode:"closed"})}get coordinates(){return this._coordinates}set coordinates(e){this._coordinates=e}connectedCallback(){this.shadow.innerHTML=`
            <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200" />
            `,this.button=document.createElement("button"),this.button.innerHTML=`
...
`;class oe extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"closed"}),this.transitioner=null}connectedCallback(){Cesium.Ion.defaultAccessToken="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiI5MjY2YmYxNy1mNTM2LTRlOWYtYTUyZC01ZmY0NjBhNzllMWEiLCJpZCI6MTY5MDU3LCJpYXQiOjE2OTU4ODQ4NzB9.bN66rOR5h37xuKVsuUSYRSLOGJy-34IhH9S1hr4NOOE",this.viewer=new Cesium.Viewer(this.shadow,{baseLayerPicker:!1,geocoder:!1,timeline:!1,animation:!1,homeButton:!1,navigationInstructionsInitiallyVisible:!1,navigationHelpButton:!1,sceneModePicker:!1,fullscreenButton:!1,infoBox:!1,sceneMode:Cesium.SceneMode.SCENE2D,mapMode2D:Cesium.MapMode2D.ROTATE}),this.viewer.screenSpaceEventHandler.setInputAction(t=>{this.dispatchEvent(new CustomEvent("map-click",{detail:{movement:t}}))},Cesium.ScreenSpaceEventType.LEFT_CLICK),this.viewer.screenSpaceEventHandler.setInputAction(t=>{this.mouseOver(t)},Cesium.ScreenSpaceEventType.MOUSE_MOVE),l.instance.subscribe("customroute-load",t=>{this.loadCustomDataSource(t,"custom-route","yellow")}),l.instance.subscribe("feature-selected",t=>{const i=u.instance.createGeoJson([t]);this.loadCustomDataSource(i,"selected-feature","orangered")}),l.instance.subscribe("customroutecard-click",t=>{const i=u.instance.createGeoJson([t]);this.loadCustomDataSource(i,"selected-feature","orangered")});const s=document.createElement("style");s.innerHTML=ne,this.shadow.append(s);const e=document.createElement("link");e.setAttribute("rel","stylesheet"),e.setAttribute("href","./css/cesium.css"),this.shadow.append(e)}getEntity(s){const e=s.position;return this.viewer.scene.pick(e)}setCameraToPosition(s){let e=this.viewer.camera.positionCartographic;e.height>2e6?e.height=2e3:e.height;const t=Cesium.Cartesian3.fromDegrees(s.longitude,s.latitude,e.height);this.viewer.camera.flyTo({destination:t,orientation:{heading:Cesium.Math.toRadians(0),pitch:Cesium.Math.toRadians(-90),roll:0},duration:.5})}checkUserPin(s){this.viewer.entities.getById("user-pin")?this.updateUserPin(s):this.createUserPin(s)}createUserPin(s){this.viewer.entities.add({name:"user_pin",id:"user-pin",position:Cesium.Cartesian3.fromDegrees(s.longitude,s.latitude,0),point:{pixelSize:8,color:Cesium.Color.BLUE,outlineColor:Cesium.Color.WHITE,outlineWidth:1}})}updateUserPin(s,e){s.position=e}mouseOver(s){const e=s.endPosition,t=this.viewer.scene.pick(e);Cesium.defined(t)&&Cesium.defined(t.id)?document.body.style.cursor="pointer":document.body.style.cursor="default"}changeMapMode(){let s=this.viewer.scene.mode;s===Cesium.SceneMode.SCENE3D?this.viewer.scene.morphTo2D(0):s===Cesium.SceneMode.SCENE2D&&this.viewer.scene.morphTo3D(0)}changeTheme(s){const e=this.viewer.imageryLayers._layers[1];if(this.viewer.imageryLayers.remove(e),Object.keys(s).length!=0){const t=this.getImageryProvider(s.url,s.layer,s.credit);this.viewer.imageryLayers.addImageryProvider(t)}}getImageryProvider(s,e,t){return new Cesium.WebMapTileServiceImageryProvider({url:s,layer:e,style:"default",format:"image/jpeg",maximumLevel:19,tileMatrixSetID:"default",credit:new Cesium.Credit(t)})}async loadLayers(s){const e=s.map(t=>this.createlayer(t).then(i=>({layer:t,data:i})));await Promise.all(e).then(async t=>{this.viewer.dataSources._dataSources.map(n=>n.name).forEach(n=>{n!=="custom-route"&&this.viewer.dataSources.getByName(n).forEach(c=>this.viewer.dataSources.remove(c))}),await Promise.all(t.map(async n=>{const o=await n.data.layer;o.name=n.layer.layer,this.viewer.dataSources.add(o),this.styleEntities(o,n.layer.style)}))})}async createlayer(s){const e=`${s.layer_url_wfs}?service=WFS&typeName=${s.layer}&outputFormat=application/json&request=GetFeature&srsname=EPSG:4326`;return fetch(e).then(t=>t.json()).then(t=>this.createAdditionalProperties(t,s)).then(t=>({features:t.features,layer:Cesium.GeoJsonDataSource.load(t)})).catch(t=>{throw console.error(t),t})}createAdditionalProperties(s,e){return s.features=s.features.map((t,i)=>(t.properties.raiseName=e.name+" "+i,t.properties.layerName=e.layer,t)),s}async loadCustomDataSource(s,e,t){this.viewer.dataSources.getByName(e).forEach(o=>{this.viewer.dataSources.remove(o)});let n=await Cesium.GeoJsonDataSource.load(s);n.name=e,await this.viewer.dataSources.add(n),this.styleCustomDataSource(n,t)}styleCustomDataSource(s,e){s.entities.values.forEach(t=>{t.billboard=void 0,t.point=new Cesium.PointGraphics({pixelSize:16,color:Cesium.Color.fromCssColorString(e).withAlpha(.01),outlineColor:Cesium.Color.fromCssColorString(e),outlineWidth:3})})}styleEntities(s,e){let t="YELLOW",i="YELLOW",n=.5;e&&e.color&&(t=e.color.toUpperCase(),i=e.color.toUpperCase()),e&&e.opacity&&(n=e.opacity),s.entities.values.forEach(o=>{switch(!0){case Cesium.defined(o.polyline):o.polyline.material=Cesium.Color.fromCssColorString(t).withAlpha(parseFloat(n)),o.polyline.width=2;break;case Cesium.defined(o.billboard):o.billboard=void 0,o.point=new Cesium.PointGraphics({pixelSize:8,color:Cesium.Color.fromCssColorString(i).withAlpha(.5),outlineColor:Cesium.Color.fromCssColorString(i),outlineWidth:1});break;case Cesium.defined(o.polygon):o.polygon.material=Cesium.Color.fromCssColorString(t).withAlpha(parseFloat(n)),o.polygon.outlineColor=Cesium.Color.fromCssColorString(t).withAlpha(parseFloat(n));break}})}}customElements.define("app-cesium",oe);class q extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"closed"})}render(){switch(this.getAttribute("active-tab")){case"suggested-route":this.suggestedRouteContent.classList.add("active"),this.customRouteContent.classList.remove("active"),this.infoContent.classList.remove("active"),this.tabs.forEach(e=>{e.id==="suggested-route-tab"?e.classList.add("active-tab"):e.classList.remove("active-tab")});break;case"custom-route":this.suggestedRouteContent.classList.remove("active"),this.customRouteContent.classList.add("active"),this.infoContent.classList.remove("active"),this.tabs.forEach(e=>{e.id==="custom-route-tab"?e.classList.add("active-tab"):e.classList.remove("active-tab")});break;default:this.suggestedRouteContent.classList.remove("active"),this.customRouteContent.classList.remove("active"),this.infoContent.classList.add("active"),this.tabs.forEach(e=>{e.id==="info-tab"?e.classList.add("active-tab"):e.classList.remove("active-tab")});break}}connectedCallback(){this.shadow.innerHTML=`
            ...
            `,this.component=this.shadow.querySelector(".component"),this.header=this.shadow.querySelector(".header"),this.legend=this.shadow.querySelector(".legend"),this.name=this.shadow.querySelector(".name"),this.category=this.shadow.querySelector(".category"),this.tools=this.shadow.querySelector(".tools"),this.goToBtn=this.shadow.querySelector("app-goto"),this.addToRouteBtn=this.shadow.querySelector("app-add-to-route"),this.info=this.shadow.querySelector("app-info-panel"),this.goToBtn.addEventListener("go-to",t=>this.goTo(t.detail.coordinates)),this.addToRouteBtn.addEventListener("add-route",()=>{l.instance.publish("addtocustomroutebtn-click",this.feature)});const e=document.createElement("link");e.setAttribute("rel","stylesheet"),e.setAttribute("href","./css/tab.info.component.css"),this.shadow.append(e)}goTo(e){const t=`https://www.google.com/maps/dir/?api=1&destination=${e.latitude},${e.longitude}`;window.open(t,"_blank")}}customElements.define("app-tab-info",ae);class f{constructor(){r(this,"_instance");if(f._instance)return f._instance;f._instance=this}static get instance(){return f._instance||(f._instance=new f),f._instance}calculateDistance(s,e){const t=s.longitude-e.longitude,i=s.latitude-e.latitude;return Math.sqrt(t*t+i*i)}nearestInsertion(s,e){const t=[...s];let i=0,n=this.calculateDistance(e,t[0].startingCoordinates);for(let c=1;c<t.length;c++){const d=this.calculateDistance(e,t[c].startingCoordinates);d<n&&(n=d,i=c)}const o=[t.splice(i,1)[0]];for(;t.length>0;){n=Number.MAX_VALUE;let c;for(let d=0;d<t.length;d++){const b=this.calculateDistance(o[o.length-1].startingCoordinates,t[d].startingCoordinates);b<n&&(n=b,c=d)}o.push(t.splice(c,1)[0])}return o}}class re extends HTMLElement{constructor(){super();r(this,"_route");r(this,"_features");this.shadow=this.attachShadow({mode:"closed"}),this.features=[],this.shadow.innerHTML=`
            ...
            `,this.dialog=this.shadow.querySelector("dialog"),this.closeBtn=this.shadow.querySelector(".cancel"),this.deleteBtn=this.shadow.querySelector(".delete");const s=document.createElement("link");s.setAttribute("rel","stylesheet"),s.setAttribute("href","./css/dialog.empty-route.component.css"),this.shadow.append(s)}connectedCallback(){this.closeBtn.addEventListener("click",()=>this.closeDialog()),this.deleteBtn.addEventListener("click",()=>{this.closeDialog(),this.dispatchEvent(new CustomEvent("empty-route"))})}openDialog(){this.dialog.showModal?this.dialog.showModal():this.dialog.setAttribute("open","")}closeDialog(){this.dialog.close?this.dialog.close():this.dialog.removeAttribute("open")}}customElements.define("app-empty-route",le);class de extends HTMLElement{constructor(){super();r(this,"_route");this.shadow=this.attachShadow({mode:"closed"}),this.shadow.innerHTML=`
            <dialog>
                <div class="content">
                    <div class="message">
            ...
            `,this.dialog=this.shadow.querySelector("dialog"),this.routeName=this.shadow.querySelector(".route-name"),this.closeBtn=this.shadow.querySelector(".cancel"),this.sortBtn=this.shadow.querySelector(".sort");const s=document.createElement("link");s.setAttribute("rel","stylesheet"),s.setAttribute("href","./css/dialog.sort-route.component.css"),this.shadow.append(s)}get route(){return this._route}set route(s){this._route=s,this.render()}render(){this.routeName.innerHTML=this.route.name}connectedCallback(){this.closeBtn.addEventListener("click",()=>this.closeDialog()),this.sortBtn.addEventListener("click",()=>{this.closeDialog(),this.dispatchEvent(new CustomEvent("sort-route"))})}openDialog(){this.dialog.showModal?this.dialog.showModal():this.dialog.setAttribute("open","")}closeDialog(){this.dialog.close?this.dialog.close():this.dialog.removeAttribute("open")}}customElements.define("app-sort-route-dialog",he);class O extends HTMLElement{constructor(){super();r(this,"_routes");this.shadow=this.attachShadow({mode:"closed"}),this.shadow.innerHTML=`
            <dialog>
                <div class="content">
                    <div class="message">
